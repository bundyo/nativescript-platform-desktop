...
import {
    ...
    setApplication,
    suspendEvent
} from "@nativescript/core/application/application-common";
...
} from "@nativescript/core/ui/styling/style-scope";
...
export function addCss(cssText: string): void {
    notify(<CssChangedEventData><unknown>{eventName: "cssChanged", object: desktopApp, cssText: cssText});
