import { encoding as textEncoding } from "../text/text.desktop";
import { desktop } from "../utils/utils.desktop";
...
export class FileSystemAccess {
    ...
    public getLastModified(path: string): Date | any {
    ...
    public getFileSize(path: string): number | any {
        // const fileManager = NSFileManager.defaultManager;
        // const attributes = fileManager.attributesOfItemAtPathError(path);
        // if (attributes) {
    ...
    public getParent(path: string, onError?: (error: any) => any): { path: string; name: string } | any {
        // try {
        //     const fileManager = NSFileManager.defaultManager;
    ...
    public getFile(path: string, onError?: (error: any) => any): { path: string; name: string; extension: string } | any {
        // try {
        //     const fileManager = NSFileManager.defaultManager;
    ...
    public getFolder(path: string, onError?: (error: any) => any): { path: string; name: string } | any {
        // try {
        //     const fileManager = NSFileManager.defaultManager;
    ...
    public getExistingFolder(path: string, onError?: (error: any) => any): { path: string; name: string } | any {
        // try {
        //     const fileManager = NSFileManager.defaultManager;
        //     const exists = this.folderExists(path);
        //
    ...
    private exists(path: string): { exists: boolean, isDirectory: boolean } | any {
        // const fileManager = NSFileManager.defaultManager;
    ...
    public concatPath(left: string, right: string): string | any {
    ...
    public getLogicalRootPath(): string | any {
    ...
    public readAsync(path: string): any {
    ...
    public writeTextAsync(path: string, content: string, encoding?: any): Promise<void> | any {
    ...
    public writeAsync(path: string, content): Promise<void> | any {
        // return new Promise<void>((resolve, reject) => {
        //     try {
    ...
    public writeSync(path: string, content, onError?: (error: any) => any) {
        try {
    ...
    private getKnownPath(folderType: number): string | any {
        // const fileManager = NSFileManager.defaultManager;
    ...
    public normalizePath(path: string): string | any {
    ...
    public joinPath(left: string, right: string): string | any {
    ...
    public joinPaths(paths: string[]): string {
        return paths.join(this.getPathSeparator()); // desktop.joinPaths(...paths);
    }
}
