...
} from "@nativescript/core/ui/layouts/grid-layout/grid-layout-common";
...
export class GridLayout extends GridLayoutBase {
    ...
    public initNativeView(): void {
        ...
        super.rowsInternal.forEach((itemSpec: ItemSpec, index, rows) => { super._onRowAdded(itemSpec); }, this);
        super.columnsInternal.forEach((itemSpec: ItemSpec, index, rows) => { super._onColumnAdded(itemSpec); }, this);
    }
