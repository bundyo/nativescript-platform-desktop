 ...
 */
import { DialogOptions, ConfirmOptions, PromptOptions, PromptResult, LoginOptions, LoginResult, ActionOptions } from "@nativescript/core/ui/dialogs";
import { getLabelColor, getButtonColors, isDialogOptions, inputType, capitalizationType, ALERT, OK, CONFIRM, CANCEL, PROMPT, parseLoginOptions } from "@nativescript/core/ui/dialogs/dialogs-common";
...
function createAlertDialog(options?: DialogOptions): any {
...
function showDialog(builder: any) {
...
function addButtonsToAlertDialog(alert, options: ConfirmOptions,
