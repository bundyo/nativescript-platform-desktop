// Definitions.
import {
    Point, dip, Observable, ViewBase,
    backgroundColorProperty, colorProperty, borderTopColorProperty, borderBottomColorProperty,
    borderRightColorProperty, borderLeftColorProperty, borderTopWidthProperty, borderBottomWidthProperty,
    borderRightWidthProperty, borderLeftWidthProperty, borderTopLeftRadiusProperty,
    borderTopRightRadiusProperty, borderBottomLeftRadiusProperty, borderBottomRightRadiusProperty
} from "@nativescript/core/ui/core/view";

import { GestureTypes, GestureEventData } from "@nativescript/core/ui/gestures";
// Types.
import {
    ViewCommon, layout, isEnabledProperty, originXProperty, originYProperty, automationTextProperty,
    isUserInteractionEnabledProperty, traceEnabled, traceWrite, traceCategories, traceNotifyEvent,
    paddingLeftProperty, paddingTopProperty, paddingRightProperty, paddingBottomProperty,
    Color, EventData, ShowModalOptions
} from "@nativescript/core/ui/core/view/view-common";
...
export class View extends ViewCommon {
    ...
    on(eventNames: string, callback: (data: EventData) => void, thisArg?: any) {
        ...
        if ((<ViewBase><unknown>this).isLoaded && !this.layoutChangeListenerIsSet && isLayoutEvent) {
    ...
    public initNativeView(): void {
        ...
        if ((<Observable><unknown>this).hasListeners(ViewCommon.layoutChangedEvent)) {
            this.setOnLayoutChangeListener();
        }
    }
    ...
    [minWidthProperty.setNative](value: Length) {
        if ((<ViewCommon><unknown>this).parent instanceof CustomLayoutView &&
    ...
    _addViewToNativeVisualTree(child: ViewCommon, atIndex: number = Number.MAX_SAFE_INTEGER): boolean {
...
const percentNotSupported = (view, value: number) => { throw new Error("PercentLength is not supported."); };
