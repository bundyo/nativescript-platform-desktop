...
} from "@nativescript/core/ui/scroll-view/scroll-view-common";
...
export class ScrollView extends ScrollViewBase {
    ...
    public scrollToVerticalOffset(value: number, animated: boolean) {
        const nativeView = this.nativeViewProtected;
        if (nativeView && (<ScrollViewBase>this).orientation === "vertical" && (<ScrollViewBase>this).isScrollEnabled) {
    ...
    public scrollToHorizontalOffset(value: number, animated: boolean) {
        const nativeView = this.nativeViewProtected;
        if (nativeView && (<ScrollViewBase>this).orientation === "horizontal" && (<ScrollViewBase>this).isScrollEnabled) {
            value *= layout.getDisplayDensity();
    ...
    _addViewToNativeVisualTree(view: ViewBase, atIndex?: number): boolean {
        ...
        (<ScrollViewBase>this).parentNode.nativeViewProtected.removeEventListener(WidgetEventTypes.Resize, this._resizeHandler.bind(this));
        (<ScrollViewBase>this).parentNode.nativeViewProtected.addEventListener(WidgetEventTypes.Resize, this._resizeHandler.bind(this));
