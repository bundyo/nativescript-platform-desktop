import { InspectorEvents, InspectorCommands } from "@nativescript/core/debugger/devtools-elements";
import { getDocument, getComputedStylesForNode, removeNode, setAttributeAsText } from "@nativescript/core/debugger/devtools-elements.common";
