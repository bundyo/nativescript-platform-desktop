import { keyboardTypeProperty, secureProperty, TextFieldBase, WhiteSpace, whiteSpaceProperty } from "@nativescript/core/ui/text-field/text-field-common";
...
export class TextField extends TextFieldBase {
  ...
  public _onReturnPress() {
    super.notify({ eventName: TextFieldBase.returnPressEvent, object: this });
  }
  ...
  setSecureAndKeyboardType(): void {
    ...
    if (super.secure) {
      ...
      switch (super.autocapitalizationType) {
        case "words":
...
(<TextFieldBase>TextField.prototype)._isSingleLine = true;
