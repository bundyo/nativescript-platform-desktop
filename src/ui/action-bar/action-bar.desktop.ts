import { ActionBarBase, ActionItemBase, backgroundColorProperty, backgroundInternalProperty, Color, colorProperty, flatProperty, isVisible, layout } from "@nativescript/core/ui/action-bar/action-bar-common";
...
export class ActionItem extends ActionItemBase {
  ...
  public initNativeView(): void {
    ...
    view.addEventListener(
      ...
      menuItemClickListener.bind(this, this)
    );
  ...
  public _removeViewFromNativeVisualTree(child: View): void {
    ...
    if (child.nativeViewProtected) {
      (<FlexLayout>this.nativeViewProtected.layout).removeWidget(
...
export class ActionBar extends ActionBarBase {
  ...
  public createNativeView(): QWidget {
    ...
    this._leftWidget.setInlineStyle(
      "background-color: red; flex-direction: row; flex: 1; align-items: center; justify-content: flex-start;"
    );
    ...
    this._titleWidget.setInlineStyle(
      "background-color: orange; flex: 0; align-items: center; justify-content: center;"
    );
    ...
    this._rightWidget.setInlineStyle(
      "background-color: red; flex-direction: row; flex: 1; align-items: center; justify-content: flex-end;"
    );
  ...
  public _updateNavigationButton() {
    ...
    if (navButton && isVisible(navButton)) {
      ...
      this.nativeViewProtected.addEventListener(
        WidgetEventTypes.MouseButtonPress,
        function(v) {
  ...
  public _removeViewFromNativeVisualTree(child: View): void {
    ...
    if (child.nativeViewProtected) {
      this[`_${child.desktop["position"]}Widget`].layout.removeWidget(
        child.nativeViewProtected
      );
    }
  }
