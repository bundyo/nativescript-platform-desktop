import { clipToBoundsProperty, isPassThroughParentEnabledProperty, LayoutBaseCommon, Length, paddingBottomProperty, paddingLeftProperty, paddingRightProperty, paddingTopProperty } from "@nativescript/core/ui/layouts/layout-base-common";
...
export class LayoutBase extends LayoutBaseCommon {
  ...
  [paddingBottomProperty.getDefault](): Length {
    return {
      value: (<LayoutBaseCommon>this)._defaultPaddingBottom,
      unit: "px"
    };
  }
