...
const USER_AGENT = `Mozilla/5.0 (${device}; CPU OS ${osVersion.replace(
  ".",
  "_"
...
export function request(
  options: httpModule.HttpRequestOptions
): Promise<httpModule.HttpResponse> {
